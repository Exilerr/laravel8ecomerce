			...
			<div class=" main-content-area">
				...
				<div class="wrap-iten-in-cart">
                        @if (Session::has('success_message'))
                            <div class="albert albert-success">
						...
						<li class="pr-cart-item">
							...
							<div class="quantity">
								<div class="quantity-input">
									...
									<a class="btn btn-reduce" href="#" wire:click.prevent="decraseQuantity('{{$item->rowId}}')"></a>
								</div>
							</div>
				...
				<div class="summary">
					<div class="order-summary">
						...
						<p class="summary-info"><span class="title">Subtotal</span><b class="index">{{Cart::subtotal()}}</b></> $</b></p>
						<p class="summary-info"><span class="title">Subtotal</span><b class="index">{{Cart::tax()}}</b></> $</b></p>
